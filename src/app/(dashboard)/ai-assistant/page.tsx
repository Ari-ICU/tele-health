    ...
    <div className="min-h-screen ">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <header className="text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-4">🤖 AI Health Assistant</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Enter your symptoms and let our AI provide insights on potential conditions and recommend next steps.
          </p>
        </header>
        ...
        <section className="bg-white/90 backdrop-blur-sm border border-blue-100 shadow-lg rounded-2xl p-6 md:p-8 transition-all duration-300">
          <h2 className="text-2xl font-bold mb-3 text-gray-800">📝 Check Your Symptoms</h2>
          <p className="text-gray-600 mb-5">
            Describe your symptoms below, separated by commas (e.g., <i>headache, fever, sore throat</i>).
          </p>
        ...
        {latestAnalysis && (
          <section className="bg-white/95 border-l-4 border-blue-500 shadow-md rounded-2xl p-6 md:p-8 animate-fade-in">
            <h2 className="text-2xl font-bold mb-4 text-blue-800">✅ AI Analysis Result</h2>
            <div className="space-y-4 text-gray-800">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <p className="font-medium text-gray-600">Risk Level</p>
                  <p className={getRiskBadge(latestAnalysis.analysis.riskLevel)}>
        ...
        <section className="bg-white/90 backdrop-blur-sm border border-gray-200 shadow-md rounded-2xl p-6 md:p-8">
          ...
          {historyLoading ? (
            ...
            <p className="text-gray-500 italic text-center py-4">No previous analyses found.</p>
          )}
        </section>
      </div>
    </div>
